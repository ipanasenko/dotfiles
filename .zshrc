...
alias sync-rebase-interactive='sync-no-rm && git rebase master -i --autosquash && rm-gone'
alias sync-merge='sync-no-rm && git merge master -m"merge master" && rm-gone'
alias master='sync-no-rm && git co master && rm-gone'
